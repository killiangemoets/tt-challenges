...
- Bad file: fail that document, show status, keep pipeline up. Retry re-enqueues; no DLQ. Non-`.md` uploads are rejected FE+BE. Office seed files are registered for visibility, not parsed, and fail with Markdown conversion guidance.
